...
Status Parameter::Data(const DataTransferManager* data_transfer_manager, OrtValue& data) const {
...
Status Parameter::SetData(const OrtValue& data, const DataTransferManager* data_transfer_manager) {
